        ...
        if (mobile.isEmpty()) {
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    MySQL2.executeIUD("INSERT INTO `customer`(`mobile`,`first_name`,`last_name`,`email`,`point`) VALUES('" + mobile + "','" + fname + "','" + lname + "','" + email + "','0')");
        ...
        if (firstName.isEmpty()) {
            ...
            try {
                ...
                if (canUpdate) {
                    ...
                    MySQL2.executeIUD("UPDATE `customer` SET `first_name` = '" + firstName + "', `last_name`='" + lastName + "', `email`='" + email + "' WHERE `mobile` = '" + mobile + "'");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            if (invoice != null) {
                ...
                invoice.getjTextFiled5().setText(String.valueOf(jTable1.getValueAt(row, 4)));
