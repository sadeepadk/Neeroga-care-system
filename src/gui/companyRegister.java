...
public class companyRegister extends javax.swing.JDialog {
    ...
    public companyRegister(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        loadCompanies();
        supplier = (supplierRegister)parent;
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            //sr.getJLabel().setText(name);
            supplier.setCompanyName(name);
            this.dispose();
            //sr.getTextField().grabFocus();
            supplier.mobileGrabFocus();
            
            supplier.setCompanyId(String.valueOf(jTable1.getValueAt(row, 0)));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Please change name or hotline number or update", "Warning", JOptionPane.WARNING_MESSAGE);
